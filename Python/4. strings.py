...
bio_data = "Name: Main Uddin, Age: 24, Country: Bangladesh"
...
formatted_string = (
    f"Name: {person_info['first_name']} {person_info['last_name']}\n"
    f"Age: {person_info['age']}\n"
    f"City: {person_info['city']}\n"
    f"Occupation: {person_info['occupation']}"
)
