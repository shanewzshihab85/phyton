...
student = {
    'name': 'Main',
    'roll_number': '201091',
    'grades': {'Math': 77, 'Science': 88, 'History': 99}
}

# Adding a new subject and its grade
student['grades']['English'] = 66

# Modifying grade for a subject
student['grades']['Science'] = 55

# Removing a subject and its grade
...
# Dictionary representing students and their grades
student_grades = {
    'Main': [77, 88, 99],
    'Tuhin': [54, 78, 65],
    'Wasif': [24, 45, 78]
